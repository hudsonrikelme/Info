...
public class ProdutoDbContext : DbContext{
    ...
    private List<Produto> RetornaProdutos(){
        ...
        new Produto { Id = 1005, Nome = "Laptop", Preço = 2000.02, Quant = 10, Descr ="Excelente notebook"},
        ...
        new Produto { Id = 1006, Nome = "HD USB", Preço = 5.00, Quant = 200, Descr ="Armazene incríveis 256GB de dados"},
        new Produto { Id = 1007, Nome = "Teste", Preço = 12.02, Quant = 20, Descr ="Teste"},
        new Produto { Id = 1008, Nome = "USB", Preço = 5.00, Quant = 200, Descr ="USB"}
    };
    }
    #endregion
}